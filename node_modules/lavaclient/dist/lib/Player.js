...
class Player extends tiny_typed_emitter_1.TypedEmitter {
    ...
    static { _a = _voiceUpdate, _b = _volume; }
    static { this.USE_FILTERS = false; }
    ...
    get position() {
        ...
        if (lastPosition == null)
            return;
        const length = this.trackData?.length, lastUpdate = this.lastUpdate;
    ...
    async setVolume(volume) {
        if (Player.USE_FILTERS) {
            await this.setFilters(v3_1.Filter.Volume, volume > 1 ? volume / 100 : volume);
        }
        else {
    ...
    async setEqualizer(arg0, ...arg1) {
        ...
        await (Player.USE_FILTERS
            ? this.setFilters(v3_1.Filter.Equalizer, bands)
